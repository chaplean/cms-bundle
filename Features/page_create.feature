Feature: Create page
  ...
  Scenario: I can see fields
    ...
    When I fill in "chaplean_cms_page_route_form_page_metaDescription" with "This is super menu"
    When I fill in "chaplean_cms_page_route_form_page_title" with "Super Menu"
    When I select "1" from "chaplean_cms_page_route_form_publication_status"
