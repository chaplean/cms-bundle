...
class LoadMediaPdfData extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $datas = array(
            ...
            '10' => array('test_path_pdf_9', 'pdf_10', '42', $now, $now, 'file-extension-pdf-pdf', 'test_pdf'),
            '11' => array('test_path_pdf_9', 'pdf_11', '42', $now, $now, 'file-extension-pdf-pdf', 'test_pdf'),
            '12' => array('test_path_pdf_9', 'pdf_12', '42', $now, $now, 'file-extension-pdf-pdf', 'test_pdf'),
        );
